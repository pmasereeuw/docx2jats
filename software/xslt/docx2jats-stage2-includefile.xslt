...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:pic="http://schemas.openxmlformats.org/drawingml/2006/picture"
    ...
    -->
    <xsl:variable name="bullet_list-style-names" as="xs:string+" select="('list_unordered', 'continued_list_unordered', 'listbullet', 'list_bullet', 'list_(bullet)', 'table_list_(bullet)', 'note_list_(bullet)')"/>
    <xsl:variable name="number_list-style-names" as="xs:string+" select="('list_arabic', 'continued_list_arabic', 'list_number', 'list_(number)', 'table_list_(number)')"/>
